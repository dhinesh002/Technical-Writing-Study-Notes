...
# def process_stock(stock, data):
#     """Process a single stock to calculate volume metrics."""
#     try:
#         if stock in data:
#             handler = TA_Handler(
#                 symbol=stock,
...
#             if data[stock]:
#                 days_14_avg_volume = data[stock]
#                 today_volume = indicators['volume']

#                 if days_14_avg_volume > 0:
#                     # Calculate percentage difference and multiple
#                     percentage_difference = ((today_volume - days_14_avg_volume) / days_14_avg_volume) * 100
#                     multiple = today_volume / days_14_avg_volume

#                     if multiple > 5:
#                         return stock, f"todayvol: {today_volume}, avg_vol: {days_14_avg_volume}, multiple: {multiple:.2f}, %: {percentage_difference:.2f}"
#         return None
...
# with open('14day_volume.txt', 'r') as file:
#     data = json.load(file)

# # Use ThreadPoolExecutor for concurrent processing
# with ThreadPoolExecutor(max_workers=100) as executor:  # Adjust max_workers based on your system's resources
#     future_to_stock = {executor.submit(process_stock, stock, data): stock for stock in filtered_list}
...
#             if processed_result:
#                 stock, details = processed_result
#                 result[stock] = details
#         except Exception as e:
#             print(f"Error in future for stock {stock}: {e}")

# # print(result)


# # Sort the result by 'multiple' in descending order
# sorted_result = dict(
#     sorted(result.items(), key=lambda x: x[1]["multiple"], reverse=True)
# )

# # Print the sorted result
# for stock, details in sorted_result.items():
#     print(
#         f"{stock}: Today Volume: {details['today_vol']}, "
#         f"14-Day Avg Volume: {details['avg_vol']}, "
#         f"Multiple: {details['multiple']:.2f}, "
#         f"Percentage Diff: {details['percentage_diff']:.2f}%"
#     )
...
#         # Check if the stock exists in the data dictionary
#         if stock in data:
#             handler = TA_Handler(
#                 symbol=stock,
#                 screener="india",
...
#                     percentage_difference = ((today_volume - days_14_avg_volume) / days_14_avg_volume) * 100            
#                     # Calculate multiple (e.g., 2x, 5x)
#                     multiple = today_volume / days_14_avg_volume

#                     if multiple > 5:
#                         result[stock] = [f' todayvol: {today_volume}, avg_vol: {days_14_avg_volume} , multiple: {multiple}, %: {percentage_difference}']
#                 else:
#                     pass
#         else:
#             pass
...
while True:
    ...
    time.sleep(500 * 60)  # 5 minutes = 5 * 60 seconds
    print("Woke up!......................................................................................")
